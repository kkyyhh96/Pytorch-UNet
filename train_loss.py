...
def train_net(net,
    ...
    #torch.manual_seed(0)
    dataset = BasicDataset(dir_img, dir_mask, img_scale, img_pickles=img_pickles)
...
#                     'the images are loaded correctly.'
                ...
                if global_step % (n_train // (10 * batch_size)) == 0:
                    ...
                    writer.add_images('images', imgs[:, 0:1, :, :], global_step)
                    if net.n_classes == 1:
...
def get_args():
    ...
    parser.add_argument('-i', '--input', type=str, default="data/imgs/",
                        help='Input folder path', dest='dir_img')
    parser.add_argument('-m', '--mask', type=str, default="data/masks/",
                        help='Input mask folder path', dest='dir_mask')
    parser.add_argument('-c', '--checkpoint', type=str, default="checkpoints/",
                        help='Input checkpoint folder path', dest='dir_checkpoint')
    parser.add_argument('-n', '--n_channels', type=int, default=3,
                        help='Number of channels', dest='n_channels')
    parser.add_argument('-p', '--img_pickles', type=str, # default="data/img_train.p",
...
if __name__ == '__main__':
    ...
    net = UNet(n_channels = args.n_channels, n_classes=1, bilinear=True)
